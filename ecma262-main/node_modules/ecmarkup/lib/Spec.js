  ...
  <li><span>Jump to the most recent link target</span><code>\`</code></li>
    ...
    buildBoilerplate() {
        ...
        if (shortname && !omitShortname) {
            ...
            const shortnameHtml = (this.opts.printable && status === 'standard'
                ? ''
        ...
        const insertMetaTag = metas.length === 0
            ? (node) => this.doc.head.prepend(node)
            : (node) => metas[metas.length - 1].after(node);
        if (!metas.some(n => n.getAttribute('property') === 'og:description')) {
            const description = (_d = ((_a = this.opts.description) !== null && _a !== void 0 ? _a : (_c = ((_b = this.doc.querySelector('emu-intro')) !== null && _b !== void 0 ? _b : this.doc.querySelector('emu-clause'))) === null || _c === void 0 ? void 0 : _c.textContent)) === null || _d === void 0 ? void 0 : _d.slice(0, 300).trim();
            if (description) {
        ...
        if (!metas.some(n => n.getAttribute('property') === 'og:title')) {
            const title = this.opts.title
                ...
                : (_e = this.doc.querySelector('title')) === null || _e === void 0 ? void 0 : _e.textContent;
            if (title) {
                const meta = this.doc.createElement('meta');
