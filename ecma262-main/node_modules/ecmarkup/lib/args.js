...
exports.options = [
    ...
    },
    {
        ...
        description: 'An external biblio.json to load; either a path prefixed with "." or "./", or a package name of an installed package that exports a biblio',
    },
    {
        name: 'write-biblio',
        type: String,
    ...
    },
    {
        ...
        description: 'Omit assets, inline them, or add them as external. Default: inline, unless --multipage or --assets-dir are specified, in which case external.',
    },
    {
        name: 'assets-dir',
        type: String,
        typeLabel: '{underline dir}',
        description: 'The directory in which to place generated assets when using --assets=external. Implies --assets=external. Defaults to [outfile]/assets.',
    },
    {
        name: 'no-toc',
        type: Boolean,
    ...
    },
    {
        ...
        description: 'The formatter for warnings and errors; either a path prefixed with "." or "./", or package name, of an installed eslint compatible formatter (default: eslint-formatter-codeframe)',
    },
    {
        name: 'multipage',
        type: Boolean,
