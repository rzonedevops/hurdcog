...
function commonIndent(lines) {
    ...
    let common = (_a = lines[0].match(/^[ \t]+/)) === null || _a === void 0 ? void 0 : _a[0];
    if (common == null) {
        return '';
    }
...
async function printStep(source, item, indent) {
    ...
    const stepSource = source.substring(item.location.start.offset, item.contents[item.contents.length - 1].location.end.offset);
    ...
    for (let i = 0; i < contents.length; ++i) {
        ...
        switch (node.name) {
            ...
            case 'text': {
                ...
                output.append((0, text_1.printText)(originalText, indent, commonIndent));
                break;
            }
            case 'comment': {
