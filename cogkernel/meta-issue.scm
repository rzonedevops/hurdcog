...
;;;
;;; This issue is a living, executable contract. Each section is an actionable, testable, and evolvable code fragment.
;;; All subsystems must be rigorously implemented, tensor-shaped, and recursively auditable.
;;;
;;; Subsystems: Memory (AtomSpace), Task (Agent-Zero), AI (PLN/MOSES), Autonomy (Meta-Agents), Build (Guix)
